...
{
    public class JOB_ATTRIBUTEMap : EntityTypeConfiguration<JOB_ATTRIBUTE>
    {
        public JOB_ATTRIBUTEMap()
        {
            // Primary Key
            this.HasKey(t => t.JOB_ATTRIBUTE_ID);
            ...
            // Relationships
            this.HasRequired(t => t.JOB_ATTRIBUTE_GROUP)
                .WithMany(t => t.JOB_ATTRIBUTE)
                .HasForeignKey(d => d.JOB_ATTRIBUTE_GROUP_ID);

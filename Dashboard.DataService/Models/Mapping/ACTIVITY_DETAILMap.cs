...
{
    public class ACTIVITY_DETAILMap : EntityTypeConfiguration<ACTIVITY_DETAIL>
    {
        public ACTIVITY_DETAILMap()
        {
            // Primary Key
            this.HasKey(t => t.ACTIVITY_DETAIL_ID);
            ...
            this.HasRequired(t => t.ACTIVITY)
                .WithMany(t => t.ACTIVITY_DETAIL)
                .HasForeignKey(d => d.ACTIVITY_ID);
            this.HasOptional(t => t.ACTIVITY_GROUP)
                .WithMany(t => t.ACTIVITY_DETAIL)
                .HasForeignKey(d => d.ACTIVITY_GROUP_ID);
            this.HasOptional(t => t.INDIVIDUAL_GROUP)
                .WithMany(t => t.ACTIVITY_DETAIL)
                .HasForeignKey(d => d.DEFAULT_INDIVIDUAL_GROUP_ID);

...
{
    public class syncobj_0x3737334543413737Map : EntityTypeConfiguration<syncobj_0x3737334543413737>
    {
        public syncobj_0x3737334543413737Map()
        {
            // Primary Key
            this.HasKey(t => new { t.CC_ID, t.CHURCH_ID, t.INDIVIDUAL_ID });

            // Properties
            this.Property(t => t.CC_ID)
            ...
            this.ToTable("syncobj_0x3737334543413737");

...
{
    public class PAY_ORDER_STATUS_TYPEMap : EntityTypeConfiguration<PAY_ORDER_STATUS_TYPE>
    {
        public PAY_ORDER_STATUS_TYPEMap()
        {
            // Primary Key
            this.HasKey(t => t.PAY_ORDER_STATUS_TYPE_ID);
            ...
            this.ToTable("PAY_ORDER_STATUS_TYPE");

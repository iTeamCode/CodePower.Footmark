...
{
    public class STAFFING_SCHEDULE_INSTANCE2Map : EntityTypeConfiguration<STAFFING_SCHEDULE_INSTANCE2>
    {
        public STAFFING_SCHEDULE_INSTANCE2Map()
        {
            // Primary Key
            ...
            this.ToTable("STAFFING_SCHEDULE_INSTANCE2");

...
{
    public class JOB_STATUS_RESTRICTIONMap : EntityTypeConfiguration<JOB_STATUS_RESTRICTION>
    {
        public JOB_STATUS_RESTRICTIONMap()
        {
            // Primary Key
            this.HasKey(t => new { t.JOB_ID, t.STATUS_GROUP_ID, t.STATUS_ID, t.STATUS_SELECTLIST });
            ...
            this.ToTable("JOB_STATUS_RESTRICTION");
            ...
            this.HasRequired(t => t.JOB)
                .WithMany(t => t.JOB_STATUS_RESTRICTION)

...
{
    public class syncobj_0x3733353342313444Map : EntityTypeConfiguration<syncobj_0x3733353342313444>
    {
        public syncobj_0x3733353342313444Map()
        {
            // Primary Key
            this.HasKey(t => new { t.INDIVIDUAL_PREF_ID, t.INDIVIDUAL_ID, t.ACTIVITY_ID, t.CHURCH_ID });

            // Properties
            this.Property(t => t.INDIVIDUAL_PREF_ID)
            ...
            this.ToTable("syncobj_0x3733353342313444");
